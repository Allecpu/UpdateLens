...
const CssPage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Modern Lists Layout - Microsoft Lists Style UI */}
      <section className="ul-surface">
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <thead className="sticky top-0 bg-amber-100/80 text-xs uppercase tracking-wide text-muted-foreground dark:bg-amber-900/25">
              <tr>
                <th className="w-12 bg-amber-100/90 px-3 py-2 dark:bg-amber-900/30">
                  <input
                    type="checkbox"
                ...
                {isColumnVisible('customer') && (
                  <th className="bg-amber-100/90 px-3 py-2 dark:bg-amber-900/30">
