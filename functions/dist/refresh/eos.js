...
import { todayStamp, monthStamp, slugify } from '../shared/utils.js';
const SOURCE_URL = 'https://docs.eos-solutions.it/it/docs/apps-func/whats-new-eos-apps.html';
const monthMap = {
    gennaio: 1,
    febbraio: 2,
    marzo: 3,
...
const parseAvailability = (text) => {
    ...
    const monthMatch = normalized.match(/(gennaio|febbraio|marzo|aprile|maggio|giugno|luglio|agosto|settembre|ottobre|novembre|dicembre)\s+(20\d{2})/);
    if (monthMatch) {
